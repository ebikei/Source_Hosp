...
PoisModel_int<-function(disease,datasetname,denominator){
     covariates=c('ExpoCool','ExpoWarm','DayIndex','ns(meanapptemp,df.temp)','ns(day,df.day)','Warm')
#     covariates=c('ExpoCool','ExpoWarm','DayIndex', 'ns(meanapptemp,df.temp)','ns(coolday,16)','ns(warmday,16)')     
#     covariates=c('ExpoCool','ExpoWarm','DayIndex', 'ns(meanapptemp,df.temp)','Warm','YEAR') 
