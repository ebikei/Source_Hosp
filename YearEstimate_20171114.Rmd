...
setwd('F:\\Research\\Source_Hosp\\Data')
load('DF_20170714.RData') #DF
#source("F:\\Research\\Source_Hosp\\Code\\Source_Hosp\\TLNise.R")
source("F:\\Research\\Source_Hosp\\Code\\Source_Hosp\\TLNise.mv1.R")
source("F:\\Research\\Source_Hosp\\Code\\Source_Hosp\\init.R")
source("F:\\Research\\Source_Hosp\\Code\\Source_Hosp\\internal.R")
source("F:\\Research\\Sourinstall.packages("thepackage"ce_Hosp\\Code\\Source_Hosp\\zzz.R")

.libPaths("C:\\Users\\Keita\\Downloads")
...
load('Demographic.RData') #Zone_demo
...
filter(Result.1st, Outcome == 'Cardio', Pollutant == 'vehic') %>% 
