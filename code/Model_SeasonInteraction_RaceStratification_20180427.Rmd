...
#     covariates=c('exposure_cool','exposure_warm','DayIndex','Race','ns(meanapptemp,df.temp)','ns(day,df.day)',  'Warm') 
     covariates=c('exposure_cool','exposure_warm','DayIndex','ns(meanapptemp,df.temp)','ns(day,df.day)')
...
#alllist2 = filter(alllist2, Outcome =='Resp')
...
Cardio = filter(tlnise.result4, Outcome == 'Cardio') %>% 
     ggplot(aes(x=Lag,y=Effect,color=Variable)) +
     	...
     	geom_hline(yintercept=1,color='Black')+ 
          ...
          theme_bw()+
          scale_colour_manual(values=c("#00BFC4", "#F8766D"), name = 'Season', breaks=c('exposure_cool', 'exposure_warm'),labels=c('Cool','Warm'))+
