...
Original_df2$Age = relevel(Original_df2$Age ,ref='00to18')
...
for (iii in 1:dim(alllist)[1]){
     ...
     temp_matrix = out1$cov.unscaled[c(2,59:61),c(2,59:61)] * out1$dispersion 
     out = cbind(out1$coefficients[c(2,59:61),], data.frame(temp_matrix))
     out = out %>% 
