...
```{r}
test = tlnise.result2 %>% 
     select(Outcome, Pollutant, Lag, IQR, Effect_Cool, LCI_Cool, UCI_Cool, P_Cool, Effect_Warm, LCI_Warm, UCI_Warm, P_Warm) %>% 
     reshape(varying=c('Effect_Cool','LCI_Cool','UCI_Cool','P_Cool','Effect_Warm','LCI_Warm','UCI_Warm','P_Warm'),v.names=c('Effect','LCI','UCI','P'), direction='long',timevar='Season',times=c('Cool','Warm'),idvar=c('Outcome','Pollutant','Lag','IQR')) %>% 
